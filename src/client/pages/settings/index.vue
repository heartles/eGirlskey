...
<div class="vvcocwet" :class="{ wide: !narrow }" ref="el">
	<div class="nav" v-if="!narrow || page == null">
		<FormBase>
			...
			<FormGroup>
				<template #label>{{ $ts.pluskey.pluskeySettings }}</template>
				<FormLink :active="page === 'pluskey'" replace to="/settings/pluskey"><template #icon><i class="fas fa-plus"></i></template>{{ $ts.pluskey.client }}</FormLink>
			</FormGroup>
			<FormGroup>
