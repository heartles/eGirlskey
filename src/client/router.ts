...
export const router = createRouter({
	...
	routes: [
		...
		{
			path: '/@:user/pages/:pageName/view-source',
			component: page('page-editor/page-editor'),
			props: (route) => ({
				initUser: route.params.user,
				initPageName: route.params.pageName,
			}),
		},
		{ path: '/@:acct/room', props: true, component: page('room/room') },
		{
			...
			props: (route) => ({ initialPage: route.params.page || null }),
		},
		{
		...
		{ path: '/theme-editor', component: page('theme-editor') },
		{
			...
			component: page('advanced-theme-editor'),
		},
		{
			path: '/docs/:doc',
			component: page('doc'),
			props: (route) => ({ doc: route.params.doc }),
		},
		...
		{ path: '/channels/new', component: page('channel-editor') },
		{
			...
			component: page('channel-editor'),
			props: true,
		},
		{
			path: '/channels/:channelId',
			component: page('channel'),
			props: (route) => ({ channelId: route.params.channelId }),
		},
		{
			path: '/clips/:clipId',
			component: page('clip'),
			props: (route) => ({ clipId: route.params.clipId }),
		},
		...
		{ path: '/my/mentions', component: page('mentions') },
		{
			path: '/my/messaging',
			name: 'messaging',
			component: page('messaging/index'),
		},
		{
			path: '/my/messaging/:user',
			component: page('messaging/messaging-room'),
			props: (route) => ({ userAcct: route.params.user }),
		},
		{
			path: '/my/messaging/group/:group',
			component: page('messaging/messaging-room'),
		...
		{ path: '/my/groups', component: page('my-groups/index') },
		{
			...
			component: page('my-groups/group'),
			props: (route) => ({ groupId: route.params.group }),
		},
		...
		{ path: '/instance', component: page('instance/index') },
		{
			...
			name: 'note',
			component: page('note'),
			props: (route) => ({ noteId: route.params.note }),
		},
		{
			path: '/tags/:tag',
			component: page('tag'),
		...
		},
		{
			...
			props: (route) => ({ userId: route.params.user }),
		},
		{
			path: '/user-ap-info/:user',
			component: page('user-ap-info'),
			props: (route) => ({ userId: route.params.user }),
		},
		{
			path: '/instance-info/:host',
			component: page('instance-info'),
			props: (route) => ({ host: route.params.host }),
		},
		{ path: '/games/reversi', component: page('reversi/index') },
		{
			path: '/games/reversi/:gameId',
			component: page('reversi/game'),
...
export function resolve(path: string) {
	...
	return {
		...
		props: route.props?.default
			? route.props.default(resolved)
			: resolved.params,
	};
}
